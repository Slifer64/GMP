...
legend({}, 'interpreter','latex', 'fontsize',15, 'Position',[0.6656 0.2092 0.2247 0.2930]);
...
limits = [inf; 0.72];
gamma = 1e-6;
[Time, P_data] = simulateGMP_nDoF(gmp, P0, Pg, T, dt, false, limits, gamma);
[Time_rev, P_rev_data] = simulateGMP_nDoF(gmp, P0, Pg, T, dt, true, limits, gamma);
...
function [Time, Y_data, dY_data, ddY_data] = simulateGMP_nDoF(gmp, y0, g, T, dt, reverse, limits, gamma)
