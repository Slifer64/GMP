...
void loadParams()
{
  ...
  if (!nh.getParam("orient_sim_fun", orient_sim_fun)) throw std::runtime_error("Failed to load param \"orient_sim_fun\"...\n");
  ...
  else throw std::runtime_error("Unsupported orient-simulation function \"" + orient_sim_fun + "\"...\n");
