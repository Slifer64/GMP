...
public:
   ...
   */
  static void write(const gmp_::GMPo *gmp, const std::string &filename, const std::string &prefix="");
   ...
   * @param[in] prefix: The prefix that will be used for writing the names of all GMP params (optional, default="").
   */
  static void write(const gmp_::GMPo *gmp, gmp_::FileIO &fid, const std::string &prefix="");
   ...
   */
  static void read(gmp_::GMPo *gmp, const std::string &filename, const std::string &prefix="");
   ...
   * @param[in] prefix: The prefix that will be used for reading the names of all GMP params (optional, default="").
   */
  static void read(gmp_::GMPo *gmp, gmp_::FileIO &fid, const std::string &prefix="");
