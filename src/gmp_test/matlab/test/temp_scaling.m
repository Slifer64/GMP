...
ax = axes('Position',[0.0923 0.1384 0.8558 0.7519], 'FontSize',15);
hold(ax, 'on');
...
legend({}, 'interpreter','latex', 'fontsize',16, 'Orientation','horizontal', 'Position',[0.0289 0.9188 0.9671 0.0801]);
...
for k=1:length(kt_data)
    ...
    xlabel('time [$s$]', 'interpreter','latex', 'fontsize',17, 'Position',[1.9923 -0.0967 -1]);
    
end
axis tight;
plot(ax.XLim, [Pgd Pgd], 'LineWidth',2.0, 'LineStyle',':', 'Color',[0.7 0.7 0.7], 'HandleVisibility','off');
hold off;
